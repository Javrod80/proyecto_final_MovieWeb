...
export default {
    ...
    * 
    * @param {Request} req - Objeto de solicitud de Express, que contiene el ID del usuario en los parámetros de la ruta.
    * @param {Response} res - Objeto de respuesta de Express, que enviará el resultado o el error de la operación.
