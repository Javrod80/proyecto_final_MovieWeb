...
export default {
    ...
    /**
       ...
       * @async
       * @function getReviews
       * @param {import("express").Request} req - Objeto de solicitud de Express, que contiene el `movieId` en los parámetros de la solicitud.
       * @param {import("express").Response} res - Objeto de respuesta de Express, que enviará las reseñas de la película o un mensaje de error.
